...
A result of this is that each variable is completely independent of the others. This makes LCH extremely easy and intuitive to work with because we can tweak each variable in isolation.
...
```scss
background-color: oklch(50% 0.1 0deg);
```
