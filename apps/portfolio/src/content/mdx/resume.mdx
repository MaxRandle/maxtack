...
**GuChat** • Remote • August 2024 - Present

TypeScript | Node | Express

- Probe underlying problems and architect solution to address root cause rather than symptoms.
- Design and build ultra low latency public facing api for gamified telegram applet.
- Ensure end-to-end consistency and eliminate code duplication by intelligently re-using API validation schemas to generate a fully descriptive OpenAPI spec.
...
**Lendable** • London, UK • May 2023 - April 2024
...
- Increase customer safety by by adding scam prevention features to the application flow.
